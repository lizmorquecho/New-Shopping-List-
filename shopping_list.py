...
def remove_shopping_list(lists_by_name, list_name_to_remove):
    ...
    # tbd = lists_by_name.get(list_name_to_remove)
    # if lists_by_name == True:
    #     del lists_by_name["list_name_to_remove]
    # else:
    #   print "we didn't find your list"
    # # for store_name in lists_by_name["list_name_to_remove"]:

    if lists_by_name.get(list_name_to_remove) == True:
...
def display_shopping_list(lists_by_name, list_name):
    ...
    # your code here!
    lists_by_name.get("list_name")
    if lists_by_name == True:
        print lists_by_name["list_name"]
    else:
        print "your list is missing"
